...
I learned the following methodology from Matt Dancho's (@mdancho84) data science class at [business.science.io](business.science.io). If you are interested in applying R to business problems, I highly recommend you check his classes out.
...
Values higher than 10 are probably continuous. `PercenetSalaryHike`, `YearsSinceLastPromotion`, etc. 
```{r}
Data %>%
    select_if(is.numeric) %>%
    map_df(~ unique(.) %>% length()) %>% # tries to turn it into a df instead of a list
